...
const url = '../assets/PLANTILLA REPORTE_Esterilizacion.pdf'
  ...
  firstPage.drawText('ticket prueba biologica', {
    x:230,
    y: height / 2 + 43,
    size: 11,
    font: helveticaFont,
  ...
  firstPage.drawText('fecha fabrica', {
    x:186,
    y: height / 2 - 14,
    size: 11,
    font: helveticaFont,
  ...
  firstPage.drawText('fecha caducidad', {
    x:266,
    y: height / 2 - 14,
    size: 11,
    font: helveticaFont,
  ...
  firstPage.drawText('Numero carga', {
    x:47,
    y: height / 2 - 93,
    size: 11,
    font: helveticaFont,
  ...
  firstPage.drawText('Numero ciclo diario', {
    x:124,
    y: height / 2 - 93,
    size: 11,
    font: helveticaFont,
