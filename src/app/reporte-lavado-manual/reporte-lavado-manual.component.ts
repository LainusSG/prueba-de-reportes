...
const url = '../assets/PLANTILLA REPORTE_Lavado_Manual (1).pdf'
  ...
  firstPage.drawText('nombre operador', {
    x:185,
    y: height / 2 + 52,
    size: 11,
    font: helveticaFont,
  ...
  const pdfBytes = await pdfDoc.save()
    ...
    //--------------------------- Dejar de Borrar------------------------------------------
    this.saveByteArray('Reporte de LAVADO MANUAL - '+ dia+'/'+mes+'/'+año+' ('+ hora+ " horas" +' con '+ minutos+' minutos'+').pdf', pdfBytes); //-------- esta linea de codigo convierte la funcion de arriba en el formato reconocido por angulars
